...
public class Utilisateur implements Serializable {
    ...
    @Id 
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "utilisateur_seq-gen")
    @SequenceGenerator(name="utilisateur_seq-gen", sequenceName="utilisateur_idutilisateur_seq", allocationSize=500)
