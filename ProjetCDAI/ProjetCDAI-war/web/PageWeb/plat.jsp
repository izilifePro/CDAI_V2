			...
			<div class="row">
				<div class="col-md-9">
					...
					<div class="single-blog">
						<article>
							<div class="post-link"><a href="">Des menus de délices</a></div>
						</article>
					</div>
					<hr>
					<div class="single-blog">
								...
								<div id="post-carousel" class="carousel slide" data-ride="carousel">			
									<div class="carousel-inner">
										<div class="item active">
                                                                                    <img src="../template/images/plats/1.jpg" alt="">
										</div>
										<div class="item">
                                                                                    <img src="../template/images/plats/2.jpg" alt="">			
										</div>
										<div class="item">
                                                                                    <img src="../template/images/plats/3.jpg" alt="">			
										</div>
                                                                            <div class="item">
                                                                                    <img src="../template/images/plats/4.png" alt="">			
										</div> 
                                                                            <div class="item">
                                                                                    <img src="../template/images/plats/5.jpg" alt="">			
										</div>
                                                                             <div class="item">
                                                                                    <img src="../template/images/plats/6.jpg" alt="">			
										</div>
                                                                             <div class="item">
                                                                                    <img src="../template/images/plats/7.jpg" alt="">			
										</div>
                                                                             <div class="item">
                                                                                    <img src="../template/images/plat/8.jpg" alt="">			
										</div>
                                                                             <div class="item">
                                                                                    <img src="../template/images/plat/9.png" alt="">			
										</div>
				...
				<div class="col-md-3">
					<div class="sidebar-widget">
						<div class="blog-search">
                                                    <form>
                                                        <input type="text" name="search" placeholder="RECHERCHE GENERALE">
                                                        <span>
						...
						<ul>
							<li><a href="plat.jsp">NOS PLATS DU JOURS</a></li>
