			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="st-navbar-collapse">
					<ul class="nav navbar-nav navbar-right">
                                            <li><a href="../PageWeb/menu.jsp">LES MENUS</a></li>
                                            <li><a href="../PageWeb/contact.jsp">CONTACT</a></li>
						...
						<article>
                            ...
                            <div class="col-md-3">
                                <div class="sidebar-widget">
                                    ...
                                    <ul>
                                        <li><a href="reservation.jsp">Effectuer une reservation</a></li>
                                        <li><a href="../faces/PageWeb/listeAnnonceAchoisir.xhtml">Selectionner les Reservations</a></li>
                                        <li><a href="../faces/PageWeb/consulterPanier.xhtml">Consulter son panier</a></li>
                                        <li><a href="../faces/PageWeb/validerAnnonce.xhtml">Valider vos annonce</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
