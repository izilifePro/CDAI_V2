				...
				<div class="col-md-9">
					...
					<div class="single-blog">
                        ...
                        <div id="login" class="animate form">
                            <form  action="${pageContext.request.contextPath}/Reservation" autocomplete="on" method="POST"> 
                                <h1> S'inscrire </h1> 
                                <p> 
                                    <label for="nom" class="uname" data-icon="u">Date</label>
                                    <input id="date" name="date" required="required" type="text" placeholder="Date de la reservation" />
                                </p>
                                <p> 
                                    <label for="prenom" class="uname" data-icon="u">Heure de début</label>
                                    <input id="heureDebut" name="heureDebut" required="required" type="text" placeholder="De quelle heure" />
                                </p>
                                <p> 
                                    <label for="tel" class="uname" data-icon="u">Heure de fin</label>
                                    <input id="heureFin" name="heureFin" required="required" type="text" placeholder="A quelle heure" />
                                </p>
                                <p> 
                                    <label for="nbrePersonne" class="uname" data-icon="u">Nombre de personnes</label>
                                    <input id="nbrePersonne" name="nbrePersonne" required="required" type="text" placeholder="Entrez le nombre de personnes" />
                                </p>
                                <p> 
                                    <label for="restaurant" class="youpasswd" >Restaurant </label>
                                    <select name="restaurant" id="profil">
                                        <option value="#" id="client">Choisir restaurant</option>
                                        <option value="hippo" id="client">Hippo La Défense</option>
                                        <option value="mcdo" id="restaurateur">Mcdo</option>
                                        <option value="kfc" id="restaurateur">KFC</option>
                                        <option value="quick" id="restaurateur">Quick</option>
                                    </select>
                                </p>
